export default function UserProfile({ user }) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900/40 dark:to-slate-800/40 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-lg dark:shadow-2xl dark:shadow-slate-900/50 hover:shadow-xl dark:hover:shadow-slate-900/60 transition-all duration-300">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800/50 p-4 space-y-4 shadow-lg h-full flex flex-col">
